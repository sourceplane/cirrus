...
- **Stage**: Worker `cirrus-web-console-next-stage` (shadow hostname
  `https://cirrus-web-console-next-stage.<workers-subdomain>.workers.dev/`)
  - Custom domain: `https://stage.cirrus.app/` (from `CONSOLE_CUSTOM_DOMAIN` env var)
- **Prod**: Worker `cirrus-web-console-next-prod` (shadow hostname
  `https://cirrus-web-console-next-prod.<workers-subdomain>.workers.dev/`)
  - Custom domain: `https://prod.cirrus.app/` (from `CONSOLE_CUSTOM_DOMAIN` env var)
