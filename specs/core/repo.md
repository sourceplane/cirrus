...
- The approved Supabase organization is `cirrus` with slug/id
...
- Supabase Auth, Realtime, Storage, and Edge Functions are not platform source-of-truth services unless a future spec explicitly adopts them. Cirrus-owned identity remains in the identity component.
