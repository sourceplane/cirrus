...
| [`../variations/`](../variations/README.md) | **VAR** | Register | platform | Five user-scoped variations of Cirrus (launch directory, creator link-in-bio, habit tracker, subscription tracker, uptime/status page), each its own repo born from the Solo profile — evidence and epic ladder. |
