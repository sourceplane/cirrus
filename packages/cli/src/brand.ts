...
// `@saas/sdk` client class name (`Cirrus`) is intentionally NOT part of
...
export const CLI_BIN = "cirrus";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "Cirrus";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.cirrus.app";
