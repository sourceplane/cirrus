// `cirrus webhook verify` — local cryptographic verification of a
// Cirrus outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `cirrus login`.
