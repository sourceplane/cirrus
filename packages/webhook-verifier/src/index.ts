 ...
 * signature verifier for Cirrus outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Cirrus webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Cirrus webhook delivery.
 *
