...
WAS = {
    ...
    "04-workers": ["db-migrate", "admin-worker", "admin-worker-tests", "billing-worker", "billing-worker-tests",
...
# `04-workers.md` — the two landings are one story.
DOC_SHARED = {"04-workers-restore": "04-workers"}
