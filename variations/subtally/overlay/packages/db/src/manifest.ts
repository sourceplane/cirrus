...
export const manifest: MigrationManifest = {
  ...
  migrations: [
    ...
    {
      id: "200_subscriptions_core",
      context: "subscriptions",
      path: "200_subscriptions_core/up.sql",
      checksum:
        "86a090075317627295725ddc70a4e744b88e5cbdfec4483455c83fe148c9535b",
      description:
        "Subscriptions persistence foundation — recurring charges with cadence and anchor date (user-scoped)",
    },
  ],
};
