/**
 * Product surface registration (Subtally — the recurring-expense tracker).
 *
...
export const PRODUCT_LABEL = "Subtally";

/** Where an authenticated person lands (app root and post-login). */
export const PRODUCT_HOME = "/overview";
...
export const PRODUCT_NAV: ProductNavLink[] = [
  { href: "/overview", label: "Overview", icon: "Wallet" },
