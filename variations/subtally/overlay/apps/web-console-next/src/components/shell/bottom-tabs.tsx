...
import { Building2, FolderKanban, Gauge, Settings, User2, Wallet, Repeat, Tags, type LucideIcon } from "lucide-react";
...
export function BottomTabs() {
  ...
  const PRODUCT_ICONS: Record<string, LucideIcon> = { Wallet, Repeat, Tags, Settings };
