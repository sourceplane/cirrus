...
export const qk = {
  ...
  // Pulsewatch
  monitors: () => ["monitors", "list"] as const,
  monitor: (id: string) => ["monitors", "item", id] as const,
  monitorChecks: (id: string) => ["monitors", "checks", id] as const,
  incidents: () => ["monitors", "incidents"] as const,
  statusPage: () => ["monitors", "status-page"] as const,
  publicStatus: (handle: string) => ["monitors", "public", handle] as const,
};
