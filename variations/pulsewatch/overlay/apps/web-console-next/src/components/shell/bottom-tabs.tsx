...
import { Building2, FolderKanban, Gauge, Settings, User2, Activity, Siren, Globe, type LucideIcon } from "lucide-react";
...
export function BottomTabs() {
  ...
  const PRODUCT_ICONS: Record<string, LucideIcon> = { Activity, Siren, Globe, Settings };
