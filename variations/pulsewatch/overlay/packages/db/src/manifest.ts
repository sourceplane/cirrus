...
export const manifest: MigrationManifest = {
  ...
  migrations: [
    ...
    {
      id: "200_monitors_core",
      context: "monitors",
      path: "200_monitors_core/up.sql",
      checksum:
        "bc206c93ac49a24bd25c3e231c9e1c4f51ca65d1ac2e5155446db52efb67f315",
      description:
        "Monitors persistence foundation — HTTP monitors, checks, incidents, and the public status page (user-scoped)",
    },
  ],
};
