...
export const manifest: MigrationManifest = {
  ...
  migrations: [
    ...
    },
    {
      id: "200_pages_core",
      context: "pages",
      path: "200_pages_core/up.sql",
      checksum:
        "821e3f36d1c75866eb73730f9d2f6ae91d2646c295ed8d8203638a0e29581256",
      description:
        "Pages persistence foundation — the creator's page, its ordered blocks, and the click log (user-scoped)",
    },
  ],
};
