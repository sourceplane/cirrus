...
import { Building2, FolderKanban, Gauge, Settings, User2, LayoutList, Palette, BarChart3, Globe, type LucideIcon } from "lucide-react";
...
export function BottomTabs() {
  ...
  const PRODUCT_ICONS: Record<string, LucideIcon> = { LayoutList, Palette, BarChart3, Globe, Settings };
