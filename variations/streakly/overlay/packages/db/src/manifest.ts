...
export const manifest: MigrationManifest = {
  ...
  migrations: [
    ...
    },
    {
      id: "200_habits_core",
      context: "habits",
      path: "200_habits_core/up.sql",
      checksum:
        "d1140783c1ba2a1dc370c3e0f3736e9d0ec661c4025069b4ea39966b84d007d5",
      description:
        "Habits persistence foundation — habits and their daily check-ins (user-scoped)",
    },
  ],
};
