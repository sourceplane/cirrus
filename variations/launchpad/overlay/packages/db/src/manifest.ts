...
export const manifest: MigrationManifest = {
  ...
  migrations: [
    ...
    {
      id: "200_launches_core",
      context: "launches",
      path: "200_launches_core/up.sql",
      checksum:
        "e7e13fd779464e265c4aa521e0541075ee09c6797a442e83490d56e48c79c1e0",
      description:
        "Launches persistence foundation — maker profiles, products, upvotes, comments (user-scoped)",
    },
  ],
};
