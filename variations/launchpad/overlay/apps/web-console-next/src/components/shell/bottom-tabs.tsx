...
import { Building2, FolderKanban, Gauge, Settings, User2, Rocket, PlusCircle, Globe, type LucideIcon } from "lucide-react";
...
export function BottomTabs() {
  ...
  const PRODUCT_ICONS: Record<string, LucideIcon> = { Rocket, PlusCircle, Globe, User2, Settings };
