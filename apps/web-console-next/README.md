...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the Cirrus web console.
...
- Per-env Cloudflare Pages projects: `cirrus-web-console-next-{dev,stage,prod}`
